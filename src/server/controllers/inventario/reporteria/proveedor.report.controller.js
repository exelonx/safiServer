...
const getReporteProveedor = async (req = request, res = response)=>{
    ...
    try {
        ...
        const pdf = await pagina.pdf({
            format: 'TABLOID', //Tamaño de página
            ...
            <div style="display: flex; width: 60%; margin: 0 auto; align-items: center; justify-content: center; flex-direction: column"><div style="font-weight: bold; font-size: 20px;">Dr. Burger</div> <div style="color: #d12609; font-size: 15px;">Reporte de Proveedores</div></div>   
            <div style=" display: flex; justify-content: end;  width: 10%;">
