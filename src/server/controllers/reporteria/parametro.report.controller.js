...
const getReporteParametro = async (req = request, res = response) => {
    ...
    try {
        ...
        const content = await compilarTemplate('parametro', {registros: regristrosMapped})
