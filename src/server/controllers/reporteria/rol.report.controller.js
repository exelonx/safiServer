...
const getReporteRol = async (req = request, res = response)=>{
    ...
    try {
        ...
        const pdf = await pagina.pdf({
            ...
            <div style="display: flex; width: 60%; margin: 0 auto; align-items: center; justify-content: center; flex-direction: column"><div style="font-weight: bold; font-size: 20px;">Dr. Burger</div> <div style="color: #d12609">Reporte Rol</div></div>   
